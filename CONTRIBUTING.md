...
Found a bug or have an idea for a feature? You can help us
by [creating an issue](https://github.com/zalando/backstage-plugin-api-linter/issues).
...
1. [Open an issue](https://github.com/zalando/backstage-plugin-api-linter/issues) describing the problem or proposed
   feature. Ask maintainers (in the issue thread) to assign the issue to you so we know who is working on what.
